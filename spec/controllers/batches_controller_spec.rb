  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved batch as @batch" do
        ...
        post :create, {:batch => { "number" => "invalid value" }}, valid_session
        assigns(:batch).should be_a_new(Batch)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested batch" do
        ...
        Batch.any_instance.should_receive(:update_attributes).with({ "number" => "1" })
        put :update, {:id => batch.to_param, :batch => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the batch as @batch" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Batch.any_instance.stub(:save).and_return(false)
        put :update, {:id => batch.to_param, :batch => { "number" => "invalid value" }}, valid_session
        assigns(:batch).should eq(batch)
      end
